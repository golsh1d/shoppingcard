...
export default function ProductWrapperBottSec({allReorderTrigger, bagsReorderTrigger, shoesReorderTrigger, accReorderTrigger, beltsReorderTrigger, popularSortTrigger, earliestSortTrigger, latestSortTrigger, searchContent, onAdd}) {
  const [allProductsInfo , setAllProductsInfo] = useState([
    ...
    {id : 7 , category : "bag" , count : 1 , title : "Daily" , img : `${process.env.PUBLIC_URL}/imgs/bag7.jpg` , rate : "4.9" , price : "4500" , des : `Soft and slouchy, this hobo bag is all about relaxed elegance. Roomy enough for daily use, yet effortlessly stylish. Soft and slouchy, this hobo bag is all about relaxed elegance. Roomy enough for daily use, yet effortlessly stylish.`} ,
