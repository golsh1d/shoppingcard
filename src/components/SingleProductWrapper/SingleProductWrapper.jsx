...
export default function SingleProductWrapper({ id , onLogIn, onAdd }) {
  const [allProductsInfo , setAllProductsInfo] = useState([
      ...
      {id : 3 , category : "bag" , count : 3 , userSelectedCount: 1, title : "Karina" , img : `${process.env.PUBLIC_URL}/imgs/bag3.jpg` , rate : "5" , price : "3000" , des : `Spacious and sturdy, this tote is made for busy days. Great for work, shopping, or carrying your daily must-haves.Spacious and sturdy, this tote is made for busy days. Great for work, shopping, or carrying your daily must-haves.`} ,
      {id : 4 , category : "bag" , count : 10 , userSelectedCount: 1, title : "Roset" , img : `${process.env.PUBLIC_URL}/imgs/bag4.jpg` , rate : "3.5" , price : "800" , des : `A sleek crossbody with a modern edge. Lightweight, practical, and ideal for hands-free convenience. A sleek crossbody with a modern edge. Lightweight, practical, and ideal for hands-free convenience`} ,
      ...
      {id : 6 , category : "bag" , count : 12 , userSelectedCount: 1, title : "Dona" , img : `${process.env.PUBLIC_URL}/imgs/bag6.jpg` , rate : "2" , price : "3000" , des : `This sporty backpack blends comfort with style. Perfect for school, travel, or weekend adventures. This sporty backpack blends comfort with style. Perfect for school, travel, or weekend adventures.`} ,
      {id : 7 , category : "bag" , count : 1 , userSelectedCount: 1, title : "Daily" , img : `${process.env.PUBLIC_URL}/imgs/bag7.jpg` , rate : "4.9" , price : "4500" , des : `Soft and slouchy, this hobo bag is all about relaxed elegance. Roomy enough for daily use, yet effortlessly stylish. Soft and slouchy, this hobo bag is all about relaxed elegance. Roomy enough for daily use, yet effortlessly stylish.`} ,
      ...
      {id : 10 , category : "shoe" , count : 8 , userSelectedCount: 1, title : "Arcane" , img : `${process.env.PUBLIC_URL}/imgs/shoe2.jpg` , rate : "3.5" , price : "400" , des : `Chic and comfortable, these ballet flats are made for all-day wear.Their sleek design pairs effortlessly with both jeans and dresses. Chic and comfortable, these ballet flats are made for all-day wear.Their sleek design pairs effortlessly with both jeans and dresses.`} ,
      ...
      {id : 12 , category : "shoe" , count : 12 , userSelectedCount: 1, title : "Karlla" , img : `${process.env.PUBLIC_URL}/imgs/shoe4.jpg` , rate : "4" , price : "650" , des : `These strappy sandals are summer essentials.Lightweight, breathable, and ideal for beach days or city strolls. These strappy sandals are summer essentials.Lightweight, breathable, and ideal for beach days or city strolls.`} ,
      {id : 13 , category : "shoe" , count : 11 , userSelectedCount: 1, title : "Sansa" , img : `${process.env.PUBLIC_URL}/imgs/shoe5.jpg` , rate : "3" , price : "1000" , des : `Ankle boots with attitude — stylish, sturdy, and versatile.Dress them up or down, rain or shine. Ankle boots with attitude — stylish, sturdy, and versatile.Dress them up or down, rain or shine.`} ,
      {id : 14 , category : "shoe" , count : 7, userSelectedCount: 1, title : "Arya" , img : `${process.env.PUBLIC_URL}/imgs/shoe6.jpg` , rate : "5" , price : "2000" , des : `These wedge heels combine height with comfort.Perfect for brunch, garden parties, or everyday chic. These wedge heels combine height with comfort.Perfect for brunch, garden parties, or everyday chic.`} ,
      {id : 15 , category : "shoe" , count : 6 , userSelectedCount: 1, title : "Catella" , img : `${process.env.PUBLIC_URL}/imgs/shoe7.jpg` , rate : "3.8" , price : "400" , des : `Soft suede loafers that bring effortless elegance to your casual looks.Slip them on for instant style and ease. Soft suede loafers that bring effortless elegance to your casual looks.Slip them on for instant style and ease.`} ,
      {id : 16 , category : "shoe" , count : 23 , userSelectedCount: 1, title : "Petra" , img : `${process.env.PUBLIC_URL}/imgs/shoe8.jpg` , rate : "2.9" , price : "300" , des : `Glamorous evening shoes with a touch of sparkle.Perfect for weddings, parties, or any special night out. Glamorous evening shoes with a touch of sparkle.Perfect for weddings, parties, or any special night out.`} ,
      {id : 17 , category : "shoe" , count : 13, userSelectedCount: 1, title : "Daenera" , img : `${process.env.PUBLIC_URL}/imgs/shoe9.jpg` , rate : "4" , price : "1000" , des : `These combat boots are tough, trendy, and built to last.Pair them with jeans or dresses for an edgy twist These combat boots are tough, trendy, and built to last.Pair them with jeans or dresses for an edgy twist..`} ,
      {id : 18 , category : "shoe" , count : 14 , userSelectedCount: 1, title : "Amanda" , img : `${process.env.PUBLIC_URL}/imgs/shoe10.jpg` , rate : "4.5" , price : "1100" , des : `Lightweight running shoes designed for both performance and style.Ideal for workouts, errands, or athleisure looks. Lightweight running shoes designed for both performance and style.Ideal for workouts, errands, or athleisure looks.`} ,
      {id : 19 , category : "shoe" , count : 15 , userSelectedCount: 1, title : "Rachel" , img : `${process.env.PUBLIC_URL}/imgs/shoe11.jpg` , rate : "4.5" , price : "1000" , des : `These mules are the definition of effortless style.Just slip them on and go — chic, easy, and always in trend.These mules are the definition of effortless style.Just slip them on and go — chic, easy, and always in trend.`} ,
      {id : 20 , category : "acc" , count : 16 , userSelectedCount: 1, title : "Solene" , img : `${process.env.PUBLIC_URL}/imgs/acc1.jpg`, rate : "4.3" , price : "1100" , des : `This bold choker necklace is made for confident fashion lovers.With a sleek band and metallic finish, it adds edge and sophistication.Wear it alone as a standout piece or layer it with longer chains.It brings high-fashion energy to any outfit.Strong, stylish, and unapologetically bold.`} ,
      ...
      {id : 23 , category : "acc" , count : 19 , userSelectedCount: 1, title : "Liora" , img : `${process.env.PUBLIC_URL}/imgs/acc5.jpg`, rate : "3.8" , price : "1400" , des : `Stacked or solo, this minimalist bangle fits right into any jewelry wardrobe.Its simple round silhouette makes it endlessly versatile.Made from high-quality metal that resists tarnishing.Slip it on for an instant touch of shine.Elegant enough for evening, subtle enough for everyday.`} ,
      {id : 24 , category : "acc" , count : 18 , userSelectedCount: 1, title : "Eloween" , img : `${process.env.PUBLIC_URL}/imgs/acc6.jpg`, rate : "4.2" , price : "2000" , des : `This braided leather bracelet is all about laid-back luxury.Its soft texture and adjustable clasp make it as comfortable as it is cool.Perfect for casual outfits or adding contrast to feminine looks.Unisex appeal with a distinctly stylish touch.A must-have for effortless accessorizing.`} ,
      {id : 25 , category : "acc" , count : 17 , userSelectedCount: 1, title : "Nahla" , img : `${process.env.PUBLIC_URL}/imgs/acc7.jpg`, rate : "5" , price : "1700" , des : `Elevate your outfit with this chain-link bracelet — bold yet refined.Its chunky design catches the light beautifully and adds a modern twist.Great for statement styling or layering with finer pieces.Polished to perfection for an eye-catching finish.For women who love to mix strength with style.`} ,
      {id : 26 , category : "acc" , count : 16 , userSelectedCount: 1, title : "Thalia" , img : `${process.env.PUBLIC_URL}/imgs/acc8.jpg`, rate : "4" , price : "1000" , des : `This charm bracelet tells a story — your story.Adorned with tiny meaningful pendants, it's a piece that feels personal and unique.Wear it as a reminder of the moments and memories that matter most.It’s delicate, feminine, and full of sentiment.Ideal for gifting or treating yourself.`} ,
      ...
      {id : 28 , category : "acc" , count : 14 , userSelectedCount: 1, title : "Nyra" , img : `${process.env.PUBLIC_URL}/imgs/acc10.jpg` , rate : "3.5" , price : "2100" , des : `This sleek cuff bracelet brings effortless sophistication to your wrist.With its polished metal surface and open design, it’s perfect for stacking or wearing solo.It adds instant polish to both workwear and weekend outfits.Durable yet lightweight — a go-to piece for daily elegance.Refined simplicity at its best.`} ,
      {id : 29 , category : "acc" , count : 13 , userSelectedCount: 1, title : "Seraphina" , img : `${process.env.PUBLIC_URL}/imgs/acc11.jpg` , rate : "4.8" , price : "2200" , des : `Modern, minimalist, and bold — these geometric stud earrings are designed to make a quiet statement.Crafted with clean lines and a smooth finish, they suit both everyday wear and formal occasions.They bring a fresh edge to your look without overwhelming it.Ideal for lovers of contemporary, fuss-free style.Small in size, big on attitude.`} ,
      {id : 30 , category : "acc" , count : 12 , userSelectedCount: 1, title : "Vesper" , img : `${process.env.PUBLIC_URL}/imgs/acc12.jpg` , rate : "3" , price : "2000" , des : `Bring color into your wardrobe with this vibrant skinny belt.Designed to add a pop of personality to neutral outfits.Its slim shape is perfect for cinching dresses or styling trousers.An easy way to experiment with color without going overboard.Fun, fashionable, and full of energy.`} ,
      {id : 31 , category : "belt" , count : 6 , userSelectedCount: 1, title : "Calista" , img : `${process.env.PUBLIC_URL}/imgs/belt1.jpg` , rate : "3.3" , price : "3000" , des : `This fabric tie belt is simple, chic, and endlessly versatile.Wrap it once or twice, knot it or bow it — the choice is yours.Made from soft, durable material that won’t slip or wrinkle.Great for wrap dresses, tunics, or adding shape to loose fits.Easy elegance in one long ribbon.`} ,
      ...
      {id : 34 , category : "belt" , count : 8 , userSelectedCount: 1, title : "Zephyra" , img : `${process.env.PUBLIC_URL}/imgs/belt4.jpg` , rate : "4.6" , price : "2300" , des : `This transparent belt with metallic details is a fresh, fashion-forward piece.Ideal for styling over crop tops, mesh, or dresses with unique silhouettes.It creates shape without covering up your outfit.A modern choice for creative stylists.Light, edgy, and totally unique.`} ,
      {id : 35 , category : "belt" , count : 7 , userSelectedCount: 1, title : "Odessa" , img : `${process.env.PUBLIC_URL}/imgs/belt5.jpg` , rate : "4.5" , price : "2400" , des : `Crafted from faux snake skin, this animal-print belt adds a touch of wild sophistication.Its neutral tones keep it versatile, while the texture makes it stand out.Wear it with monochrome outfits for maximum impact.A fierce finishing touch for bold fashionistas.Statement accessory, subtle luxury.`} ,
      {id : 36 , category : "belt" , count : 6 , userSelectedCount: 1, title : "Lyra" , img : `${process.env.PUBLIC_URL}/imgs/belt6.jpg` , rate : "4.7" , price : "2500" , des : `A double-ring belt that mixes simplicity with utility.No buckle needed — just loop and pull for a sleek, secure fit.Great for minimalist styling or layering over jackets and cardigans.Lightweight and easy to adjust on the go.Style meets function in this modern design.`} ,
      ...
      {id : 39 , category : "belt" , count : 2 , userSelectedCount: 1, title : "Selene" , img : `${process.env.PUBLIC_URL}/imgs/belt9.jpg` , rate : "3.5" , price : "2800" , des : `Bring color into your wardrobe with this vibrant skinny belt.Designed to add a pop of personality to neutral outfits.Its slim shape is perfect for cinching dresses or styling trousers.An easy way to experiment with color without going overboard.Fun, fashionable, and full of energy`} ,
      {id : 40 , category : "belt" , count : 3 , userSelectedCount: 1, title : "Isildor" , img : `${process.env.PUBLIC_URL}/imgs/belt10.jpg` , rate : "3.8" , price : "2000" , des : `This classic black leather belt is a must-have foundation piece.Crafted from genuine leather with a matte silver buckle, it pairs with everything.From high-waisted jeans to structured blazers, it adds sleek definition.A versatile piece that balances form and function.Timeless, reliable, and built to last.`} ,
  ]) 
