...
export default function SingleProductWrapper({ id , onLogIn }) {
  ...
  function checkIsLogin() {
    ...
    if (mainProductInfo.id && mainProductInfo.title && mainProductInfo.price && mainProductInfo.count && mainProductInfo.userSelectedCount) {
        let productInfo = {
  ...
  useEffect(() => {
    ...
    setFinalProductInfo(mainProduct);

    if(mainProduct) {
      let allRelatedProducts = allProductsInfo.filter(obj => {
        if (obj.category === mainProduct.category) {
          return obj
        }
      })
  ...
  useEffect(() => {
    if(finalProductInfo && relatedProducts) {
  ...
  }, [finalProductInfo , relatedProducts]); 
    ...
    <>
      ...
      <div className='SingleProductWrapper-product-info'>
        <div className='SingleProductWrapper-left-section'>
          <div className='SingleProductWrapper-head'>
            <div className='SingleProductWrapper-title'>{finalProductInfo.title}</div>
            <div className='SingleProductWrapper-rate'>
              <span className='SingleProductWrapper-rate-span'>{finalProductInfo.rate}</span>
              <StarRoundedIcon className='SingleProductWrapper-rate-icon'/>
            </div>
          </div>
          <div className='SingleProductWrapper-des' ref={productRef}>
              {finalProductInfo.des}
          </div>
        ...
        <div className='SingleProductWrapper-right-section'>
          <div className='SingleProductWrapper-img-wrapper'>
            <img src={finalProductInfo.img} alt="productImg" className='SingleProductWrapper-img'/>
          </div>
        </div>
      </div>
      ...
      >
        ...
        {relatedProducts.map(obj => (
          <SwiperSlide>
            <Link to={`/singleProduct/${obj.id}`} className='SingleProductWrapper-slide-img-wrapper'>
              <img src={obj.img} alt="productImg" className='SingleProductWrapper-slide-img'/>
            </Link>
          </SwiperSlide>
        ))}
